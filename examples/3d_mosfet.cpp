...
int main()
{
  ...
  mysim.device().set_quantity(viennamini::id::donor_doping(),    source_ext, 1.0E24, "m-3");
  mysim.device().set_quantity(viennamini::id::acceptor_doping(), source_ext, 1.0E8,  "m-3");
  mysim.device().set_quantity(viennamini::id::donor_doping(),    drain_ext,  1.0E24, "m-3");
  mysim.device().set_quantity(viennamini::id::acceptor_doping(), drain_ext,  1.0E8,  "m-3");
