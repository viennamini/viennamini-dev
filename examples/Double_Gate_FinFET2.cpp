...
int main()
{
  ...
  //
  mysim.device().read(viennamini::device_collection_path()+"/Double_Gate/Double_Gate_FreeCAD/Double_Gate_FinFET/Double_Gate_FinFET2/Double_Gate_FinFET2_meshed.pvd", viennamini::tetrahedral_3d());
