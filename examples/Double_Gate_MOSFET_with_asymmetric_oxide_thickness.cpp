...
int main()
{
  ...
  //
  mysim.device().read(viennamini::device_collection_path()+"/Double_Gate/Double_Gate_FreeCAD/Double_Gate_MOSFET_with_asymmetric_oxide_thickness/Double_Gate_MOSFET_with_asymmetric_oxide_thickness/Double_Gate_MOSFET_with_asymmetric_oxide_thickness_meshed.pvd", viennamini::tetrahedral_3d());
