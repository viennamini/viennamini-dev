...
int main()
{
  ...
  //
  mysim.device().read(viennamini::device_collection_path()+"/FinFET/FinFET_FreeCAD/Bulk_Tri_Gate/Bulk_Tri_Gate2/meshed.pvd", viennamini::tetrahedral_3d());
 ...
 // set the temperature of the device
  ...
  //
  const int right_box		= 1;
  const int sillicon		= 2;
