...
int main()
{
  ...
  //
  mysim.device().read(viennamini::device_collection_path()+"/Double_Gate/Double_Gate_FreeCAD/Double_Gate_FinFET/Double_Gate_FinFET/meshed.pvd", viennamini::tetrahedral_3d());
...
// setup the device by identifying the individual segments
  ...
  mysim.device().make(viennamini::role::oxide,        	hard_mask,  	"hard_mask",   	   "SiO2");
