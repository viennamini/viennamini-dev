...
int main()
{
  ...
  //
  mysim.device().read(viennamini::device_collection_path()+"/Single_Gate/MOSFET/MOSFET_meshed.pvd", viennamini::tetrahedral_3d());
...
// set optional solver parameters
  ...
  mysim.config().nonlinear_breaktol()                 = 10.0E-1;
