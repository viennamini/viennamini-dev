...
int main()
{
  ...
  //
  mysim.device().read(viennamini::device_collection_path()+"/Gate_All_Around/Gate_All_Around_FreeCAD/Omega_Gate/Omega_Gate_meshed.pvd", viennamini::tetrahedral_3d());
