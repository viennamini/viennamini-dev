...
int main()
{
  ...
  mysim.device().make_oxide             (gate_oxide);
  mysim.device().set_name               (gate_oxide, "oxide");
  mysim.device().set_material           (gate_oxide, "HfO2");

  mysim.device().make_oxide             (buried_oxide);
  mysim.device().set_name               (buried_oxide, "oxide");
  mysim.device().set_material           (buried_oxide, "HfO2");
  ...
  mysim.set_output_filename_prefix("mosfet_utb_soi_3d_result");
