...
int main()
{
  ...
  //
  mysim.device().read(viennamini::device_collection_path()+"/FinFET/FinFET_FreeCAD/Tri_Gate/Tri_Gate5/meshed.pvd", viennamini::tetrahedral_3d());
...
// set optional solver parameters
  ...
  mysim.config().nonlinear_breaktol()                 = 3.0E-1;
